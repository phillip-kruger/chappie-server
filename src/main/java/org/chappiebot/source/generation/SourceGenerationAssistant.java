...
public interface SourceGenerationAssistant {
    ...
    static final String SYSTEM_MESSAGE = """
                ...
                You will receive code that needs to used as base for code generation. Use the code received as input when considering the response.

                Approach this task step-by-step, take your time and do not skip steps.
               
                Respond with the generated source code. This response must be valid {{programmingLanguage}}. Only include the {{programmingLanguage}} code, no explanation or other text. 
    ...
    public SourceGenerationOutput generateSource(@V("programmingLanguage")String programmingLanguage, 
